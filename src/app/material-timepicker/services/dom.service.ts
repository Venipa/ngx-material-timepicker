...
export class DomService {
    ...
    appendTimepickerToBody(
        timepicker: Type<NgxMaterialTimepickerContainerComponent>,
        ...
        Object.keys(config).forEach(
            (key) => (this.componentRef.instance[key] = config[key])
        );

        this.appRef.attachView(this.componentRef.hostView);
        const domElement: HTMLElement = (this.componentRef
            .hostView as EmbeddedViewRef<NgxMaterialTimepickerContainerComponent>)
            .rootNodes[0];
